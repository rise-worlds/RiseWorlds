package com.flengine.context.materials
{
    ...
    public class FDrawTextureCameraVertexShaderBatchMaterial2 extends Object implements IGMaterial
    {
        ...
        private static const NORMALIZED_VERTICES:Vector.<Number> = FDrawTextureCameraVertexShaderBatchMaterial2.Vector.<Number>([-0.5, 0.5, -0.5, -0.5, 0.5, -0.5, 0.5, 0.5]);
        private static const NORMALIZED_UVS:Vector.<Number> = FDrawTextureCameraVertexShaderBatchMaterial2.Vector.<Number>([0, 1, 0, 0, 1, 0, 1, 1]);
        private static var _helpBindVector:Vector.<Number> = FDrawTextureCameraVertexShaderBatchMaterial2.Vector.<Number>([1, 0, 0, 0.5]);
        ...
        public function FDrawTextureCameraVertexShaderBatchMaterial2()
        {
            ...
            VertexShaderCode = new FCameraTexturedQuadVertexShaderBatchMaterialVertex2_ash() as ByteArray;
            VertexShaderNoAlphaCode = new FCameraTexturedQuadVertexShaderBatchMaterialVertexNoAlpha2_ash() as ByteArray;
            return;
        }
        ...
        public function initialize(param1:Context3D) : void
        {
            ...
            __vb3VertexBuffer.uploadFromVector(_loc_4, 0, 4 * 30);
            __vb3UVBuffer = __cContext.createVertexBuffer(4 * 30, 2);
            __vb3UVBuffer.uploadFromVector(_loc_6, 0, 4 * 30);
            __vb3RegisterIndexBuffer = __cContext.createVertexBuffer(4 * 30, 4);
            __vb3RegisterIndexBuffer.uploadFromVector(_loc_2, 0, 4 * 30);
            ...
            __ib3Indexbuffer.uploadFromVector(_loc_5, 0, 6 * 30);
        ...
        {
            var _loc_8:* = param6.cContextTexture.tTexture;
            var _loc_10:* = __cActiveContextTexture != _loc_8;
            var _loc_12:* = __iActiveFiltering != param6.iFilteringType;
            var _loc_13:* = !__bUseSeparatedAlphaShaders || param2 != 1 || param3 != 1 || param4 != 1 || param5 != 1;
            var _loc_14:* = __bActiveAlpha != _loc_13;
            var _loc_9:* = __iActiveAtf != param6.iAtfType;
            var _loc_11:* = __cActiveFilter != param7;
            if (_loc_10 || _loc_12 || _loc_14 || _loc_9 || _loc_11)
            {
                ...
                if (_loc_10)
                {
                    __cActiveContextTexture = _loc_8;
                    __cContext.setTextureAt(0, _loc_8);
                }
                if (_loc_12 || _loc_14 || _loc_9 || _loc_11)
                {
                    __iActiveFiltering = param6.iFilteringType;
                    __bActiveAlpha = _loc_13;
