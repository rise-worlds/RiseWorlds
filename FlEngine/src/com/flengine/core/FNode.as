	...
	public class FNode extends Object
	{
		...
		public function getPrototype():XML
		{
			...
			else
			{
				...
				var _loc2_:FComponent = __cFirstComponent;
				while (_loc2_)
				{
					_loc3_.components.appendChild(_loc2_.getPrototype());
					_loc2_ = _loc2_.cNext;
				}
				_loc3_.children =  <children/>;var _loc1_:FNode = _cFirstChild;
				while (_loc1_)
				{
		...
		public function removeTag(param1:String):void
		{
			...
			{
				var _loc2_:Number = __aTags.indexOf(param1);
				if (_loc2_ == -1)
				{
					return;
				}
		...
		public function disposeChildren():void
		{
			...
			else
			{
				...
				var _loc1_:FNode = _cFirstChild.cNext;
				while (_loc1_)
				{
		...
		public function addComponent(param1:Class, param2:Class = null):FComponent
		{
			...
			else
			{
				...
				var _loc3_:FComponent = new param1(this);
				if (_loc3_ == null)
				{
		...
		public function removeComponent(param1:Class):void
		{
			...
			{
				var _loc2_:FComponent = __dComponentsLookupTable[param1];
