...
class MonsterBase extends VectorElements implements ILife{
    ...
    private checkLast(str:string){
        ...
        //var mz: string = this.view._getFrameLabelByFrame(nextFrameNum).name;
        var mz: string = this.view.movieClipData.frames[nextFrameNum].name;
        if( mz != str){
    ...
    private checkLastEnd(curLabel:string){
        var nextFrameNum:number = this.view.currentFrame+1;
        //var label: string = this.view._getFrameLabelByFrame(nextFrameNum).name;
        var label: string = this.view.movieClipData.frames[nextFrameNum].name;
