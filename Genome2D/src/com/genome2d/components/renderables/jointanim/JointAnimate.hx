...
class JointAnimate
{
	...
	//public function get drawScale():Float
	//{
	//	return (_drawScale);
	//}
	...
	//public function get imgScale():Float
	//{
	//	return (_imgScale);
	//}
	...
	private function LoadSpriteDef(steam:ByteArray, jaSpriteDef:JASpriteDef):Bool
	{
		...
		while (_local22 < _local5)
		{
			...
			if ((_local4 & 4) != 0)
			{
				...
				while (_local19 < _local13)
				{
					...
					if ((_local7 & 0x1000) != 0)
					{
						_local25.transform.matrix.m00 = (steam.readInt() / 0x10000);
						_local25.transform.matrix.m01 = (steam.readInt() / 0x10000);
						_local25.transform.matrix.m10 = (steam.readInt() / 0x10000);
						_local25.transform.matrix.m11 = (steam.readInt() / 0x10000);
					}
					else
					{
						if ((_local7 & 0x4000) != 0)
		...
		if (_local5 == 0)
		{
			//jaSpriteDef.frames.splice(0, jaSpriteDef.frames.length);
			//jaSpriteDef.frames.push(new JAFrame());
